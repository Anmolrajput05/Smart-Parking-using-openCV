...
def processParkingGate(userPhone):
...
def processGateOperation(userPhone,entranceGateAction,exitGateAction):
    if entranceGateAction == "Opening":
        processParkingGate(userPhone)
    elif exitGateAction == "Opening":
        processExitGate(userPhone)
...
if __name__=="__main__":
    ...
    while(True):
        ...
        if userPhone == 'NO_REQUESTS':
            continue
        processGateOperation(userPhone,entranceGateAction,exitGateAction)

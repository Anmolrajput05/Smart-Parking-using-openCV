					...
					<div class="panel-heading">
                        ...
                        <div class="panel-body">
							<button onclick="registerRequestToScanNumberPlate()" id="register_button" class="btn btn-default col-md-12">Scan</button></br></br></br>
								...
								<a href="parkingstep2.php" id="register_button" class="btn btn-default col-md-12">Confirm</a></br></br>
...
function registerRequestToScanNumberPlate(){
  ...
  xhttp.open("GET", "register_number_plate_scan_requests.php?register_scan_request_for_parking=\"\"&userPhone="+phoneNo, true);
  xhttp.send();
}
var i = 0;
...
function retriveRegistrationNo(){
  ...
  xhttp.open("GET", "get_scanned_registration_number_and_status.php?scanNumberStatusParking=\"\"&\"&userPhone="+phoneNo, true);
  xhttp.send();
}
